...
namespace WIS.InternalServices.Controllers
{
    public class CLIController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Clients_Grid(GridWrapper data, CancellationToken cancelToken)
        {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Clients_Form(FormWrapper data, CancellationToken cancelToken)
        {
