...
export declare class Formik<Values = FormikValues> extends React.Component<FormikConfig<Values>, FormikState<Values>> {
    ...
    runFieldLevelValidations(values: FormikValues, fieldId?: string): Promise<FormikErrors<Values>>;
    ...
    submitFormWithValidation: () => Promise<void>;
    executeSubmit: () => void;
    handleBlur: (eventOrPath: string | React.FocusEvent<any>) => void | ((e?: React.FocusEvent<any> | undefined) => void);
    setFieldTouched: (field: string, touched?: boolean, shouldValidate?: boolean) => void;
    setFieldError: (field: string, message: string | undefined) => void;
    setFieldPristine: (field: string) => void;
    resetForm: (nextValues?: Values | undefined, postUpdate?: (() => void) | undefined) => void;
    handleReset: () => void;
