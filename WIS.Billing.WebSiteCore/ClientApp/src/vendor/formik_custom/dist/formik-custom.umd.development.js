(function (global, factory) {
    ...
    (global = global || self, factory(global['formik-custom'] = {}, global.React));
    ...
    */
    ...
    function (_super) {
      ...
      function Formik(props) {
        ...
        _this.runValidations = function (values, fieldId) {
          if (values === void 0) {
          ...
          var _a = makeCancelable(Promise.all([_this.runFieldLevelValidations(values, fieldId), _this.props.validationSchema ? _this.runValidationSchema(values) : {}, _this.props.validate ? _this.runValidateHandler(values) : {}]).then(function (_a) {
              ...
              _this.setState(function (prevState) {
                if (!reactFastCompare(prevState.errors, errors)) {
                  if (fieldId && !Object.prototype.hasOwnProperty.call(errors, fieldId)) {
                    var errors_1 = Object.keys(prevState.errors).reduce(function (newObj, key) {
                      if (key !== fieldId) {
                        newObj[key] = prevState.errors[key];
                      }
          ...
          var executeChange = function (eventOrValue, maybePath) {
            ...
            if (field) {
              _this.setState(function (prevState) {
                ...
                if (_this.props.validateOnChange) {
                  _this.runValidations(setIn(_this.state.values, field, value), field);
                }
              });
            }
          };
          ...
          if (_this.didMount) {
            _this.setState(function (prevState) {
              ...
              if (_this.props.validateOnChange && shouldValidate) {
                _this.runValidations(_this.state.values, field);
              }
            });
          }
        };
        ...
        _this.submitForm = function () {
          if (_this.props.validateOnSubmit) {
            _this.submitFormWithValidation();
          } else {
            _this.submitFormWithoutValidation();
          }
        };

        _this.submitFormWithoutValidation = function () {
          _this.setState(function (prevState) {
            return {
              isSubmitting: true,
        ...
        _this.submitFormWithValidation = function () {
          _this.setState(function (prevState) {
            return {
        ...
        _this.setFieldPristine = function (field) {
          _this.setState(function (prevState) {
            return __assign({}, prevState, {
      ...
      Formik.prototype.runFieldLevelValidations = function (values, fieldId) {
        var _this = this;

        var fieldKeysWithValidation = [];

        if (!fieldId) {
          fieldKeysWithValidation = Object.keys(this.fields).filter(function (f) {
            return _this.fields && _this.fields[f] && _this.fields[f].props.validate && isFunction$1(_this.fields[f].props.validate);
          });
        } else if (this.fields && this.fields[fieldId] && this.fields[fieldId].props.validate && isFunction$1(this.fields[fieldId].props.validate)) {
...
//# sourceMappingURL=formik-custom.umd.development.js.map
