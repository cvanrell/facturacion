    ...
    function Formik(props) {
        ...
        _this.runValidations = function (values, fieldId) {
            ...
            var _a = makeCancelable(Promise.all([
                _this.runFieldLevelValidations(values, fieldId),
        ...
        _this.setFieldPristine = function (field) {
            _this.setState(function (prevState) { return (tslib_1.__assign({}, prevState, { touched: setIn(prevState.touched, field, undefined) })); });
        };
...
//# sourceMappingURL=formik-custom.cjs.development.js.map
