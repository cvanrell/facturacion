...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.T_LOG_BILL", b =>
                {
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.T_LOG_HOUR_RATE", b =>
                {
                    ...
                    b.Property<long?>("LogAdjustmentNU_LOG");
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.T_LOG_IPC", b =>
                {
                    b.Property<int>("NU_LOG")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.Bill", b =>
                {
                    b.HasOne("WIS.Billing.EntitiesCore.Entities.Support", "Support")
                        .WithMany("Bills")
            ...
            modelBuilder.Entity("WIS.Billing.EntitiesCore.Entities.T_LOG_HOUR_RATE", b =>
                {
                    b.HasOne("WIS.Billing.EntitiesCore.Entities.T_LOG_RATE_ADJUSTMENTS", "LogAdjustment")
                        .WithMany()
